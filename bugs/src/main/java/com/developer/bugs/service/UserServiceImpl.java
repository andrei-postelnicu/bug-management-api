...
import com.developer.bugs.entity.Authority;
import com.developer.bugs.entity.User;
import com.developer.bugs.repository.UserRepository;
...
public class UserServiceImpl implements UserService {
    ...
    public void deleteUser() {
        ...
        if (isLastAdmin(user)) {
            throw new ResponseStatusException(HttpStatus.FORBIDDEN, "The last Admin cannot be deleted");
        }
